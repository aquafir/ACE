...
namespace ACE.Server.WorldObjects
{
    ...
    partial class WorldObject
    {
        ...
        {
            get => GetProperty(PropertyInt64.CreatureKills);
            set { if (!value.HasValue) RemoveProperty(PropertyInt.CreatureKills); else SetProperty(PropertyInt64.CreatureKills, value.Value); }
        }
